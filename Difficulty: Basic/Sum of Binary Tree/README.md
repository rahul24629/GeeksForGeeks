<h2><a href="https://www.geeksforgeeks.org/problems/sum-of-binary-tree/1?page=6&category=CPP,Tree&sortBy=submissions">Sum of Binary Tree</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 14pt;">Given a binary tree, find the sum of values of all the nodes.&nbsp;<br></span></p>
