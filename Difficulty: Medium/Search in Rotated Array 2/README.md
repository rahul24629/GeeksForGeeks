<h2><a href="https://www.geeksforgeeks.org/problems/search-in-rotated-array-2/1?page=5&category=CPP,Binary%20Search&sortBy=submissions">Search in Rotated Array 2</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 14pt;">Given a sorted and rotated array <strong>arr[]</strong> and a target <strong>key</strong>. Check whether the key is present in the array or not.<br></span></p>
